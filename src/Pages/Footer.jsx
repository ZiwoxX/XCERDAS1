				...
				<div class="md:flex md:justify-between">
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="520888749_17842973199540783_7008814910331063318_n.-fotor-20250725163525.png"
								alt=""
								className="h-[4.5rem] w-[4.5em]"
							/>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/en_je_em/" class="hover:underline">
										Najim
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/dall/?hl=id" class="hover:underline">
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/unclairone.smansa/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X.CERDAS 1 | Di Kelola Oleh Siswa-Siswi X.CERDAS 1
						</p>
					</div>
				</div>
			</div>
